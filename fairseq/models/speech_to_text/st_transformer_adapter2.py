...
@register_model("st_transformer_adapter2")
class StTransformerAdapter2(StTransformerAdapter):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, sample=None, step=0, **kwargs):
        ...
        with torch.no_grad():
            ...
            p_asr = F.softmax(asr_decoder_out[0], dim=-1, dtype=torch.float32)
...
@register_model_architecture(model_name="st_transformer_adapter2", arch_name="st_transformer_adapter2")
