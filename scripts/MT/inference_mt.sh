...
#DATA=/home/data_ti6_c/wangdq/data/ST/large/MT/wmt
...
sentence_model=/home/data_ti6_c/wangdq/ST/middle/ende/st.model
...
fairseq-generate $DATA \
  ...
  --remove-bpe \
  -s en -t de \
  --path /home/data_ti6_d/wangdq/save/$3/checkpoint_best.pt \
  --results-path ~/$2 \
...
python scripts/average_checkpoints.py --input /home/data_ti6_d/wangdq/save/$3/checkpoint.best_bleu --output /home/data_ti6_d/wangdq/save/$3/checkpoint_ave_best.pt
...
fairseq-generate $DATA \
  ...
  --remove-bpe \
  -s en -t de \
  --path /home/data_ti6_d/wangdq/save/$3/checkpoint_ave_best.pt \
  --max-len-a 1.2 \
  --max-len-b 10 \
  --results-path ~/$2 \
  --model-overrides "{'valid_subset': '$4'}" \
