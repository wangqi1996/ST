...
fairseq-train /home/data_ti6_c/wangdq/data/ST/ende/ST \
  ...
  --save-dir /home/wangdq/save/join/woDAE/ \
  --num-workers 0 --max-tokens 20000 --max-update 200000 --update-freq 2 \
  --task speech_transcript_to_text --criterion st_loss --label-smoothing 0.1 \
  --arch st_join --optimizer adam --lr 2e-3 --lr-scheduler inverse_sqrt \
